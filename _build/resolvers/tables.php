...
if ($transport->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modx->addPackage('tgwhaicons', MODX_CORE_PATH . 'components/tgwhaicons/model/');
            $manager = $modx->getManager();
            $objects = [];
            $schemaFile = MODX_CORE_PATH . 'components/tgwhaicons/model/schema/tgwhaicons.mysql.schema.xml';
